...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    var accordionToggles = Array.from(document.querySelectorAll('[accordion-toggle]'));
    var accordionContents = Array.from(document.querySelectorAll('[accordion-content]'));
    ...
    if (accordionToggles && accordionToggles.length > 0 && accordionContents && accordionContents.length > 0) {
      (function () {
        ...
        var updateActiveClass = function updateActiveClass(i) {
